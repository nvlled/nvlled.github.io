...
local contents = DIV {
    ...
    problem in hand]] /
    footnote.c "This is probably a inadequate definition, feel free to look up a proper definition to help."
...
function colonizeSolarSystem(ss: SolarSystem) {
  for (const body of ss.celestialBodies) {
    ...
    code! It says so in the 10 year-old ]] /
    A { href = "https://en.wikipedia.org/wiki/Abstraction_principle_%28computer_programming%29", "old wikipedia page" } /
    [[":]],

...
import { createFootnoter, Layout, Markdown, Post } from "components";
import { tw } from "$twind/css";
import { renderToString } from "https://esm.sh/v106/preact-render-to-string@5.2.6/src/index";
import { codeBlock } from "../syntax_highlighter.tsx";

export const data: PageData = {
  title: "Abstraction",
  created: "2023-02-07 20:21:00",
};

/*
const ft = createFootnoter();
md(`

  some text here
  some text ${ft("some text here")}
  some text ${ft("this is a footnote, asjdofias jdofias")}
...
export const render: PageRender = async () => {
  ...
  return (
    <Layout>
      ...
      for drying the wet code${footnote(`For anyone unfamiliar with these terms, DRY stands
      ...
      problem in hand${footnote(
        `This is probably a inadequate definition, feel free to look up a proper definition to help.`
      )}. 
      This is quite a general definition,
      but in terms of programming, abstraction includes DSLs, macros,
      type definitions, and functions${footnote(`Yes, even functions.
...
`
        ...
        <Markdown
          text={`
      Even if you aren't into planetary invasion${footnote(`There's no political commentary here, leaders can be
  ...
  function colonizeSolarSystem(ss: SolarSystem) {
    for (const body of ss.celestialBodies) {
      ...
      these acronyms (DRY, AHA, YAGNI, WET, SPOT, KISS, AHAHA${footnote(
        "Not an acronym, I'm just laughing maniacally AHAHA"
      )})
      ...
      [old wikipedia page](https://en.wikipedia.org/wiki/Abstraction_principle_%28computer_programming%29)"
      ...
      AI summary${footnote("Kagi's universal summarizer")}:

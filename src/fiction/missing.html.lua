...
page.data.title = 'Missing'

return LAYOUT {
    read = true,
    H1 { page.data.title },
    PRE [[
        A week of power outage forced me to go outside. I wasn't planning on leaving my den for many more years, but things
    ...
    H2 'Notes',
    UL {
        LI 'Originally titled "Exodus"',
        LI 'Truncated/edited to remove sensitive themes',
    }
}

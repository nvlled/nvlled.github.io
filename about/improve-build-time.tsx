...
export const render: PageRender = () => {
  return (
    <PostLayout data={data} icon="about">
      ...
      thumbnails, and just by including it, the build time increases to about a
      half-second. I moved this to an external script in the tools/ directory,
      so it doesn't get imported every build.
      <Post.BR />
      ...
      made a lot of test pages, so the build time noticeably got slower. Instead
      of dynamic imports, I just generate a file that imports all the page
      files, which is an idea I got while trying out deno-fresh.
      <Post.BR />

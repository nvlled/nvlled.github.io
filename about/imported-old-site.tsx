...
export const render: PageRender = () => {
  return (
    <PostLayout data={data} icon="about">
      ...
      site generator. It was relatively straightforward, except the part where I
      had to fix all the missing closing tags of {"<p>"}. The missing {"</p>"}{" "}
      is an intentional omission though, since that was the recommended way of
      writing HTML in the old days. With JSX though, the omission made my editor
      go all squiggly red all over. Which is a good thing, since subtle and hard
      to spot errors gets immediately detected. I even noticed the improperly
      closed tags like {"<styled>...<styled>"}
      ...
      understand what prompted me to write such things. I'd like to believe I'm
      a better person now, but no, I still write dumb things.
      <Post.BR />
